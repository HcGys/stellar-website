  ...
  layout: (cfg) => {
    ...
    friendsjs.requestAPI(cfg.api, function(data) {
      ...
      arr.forEach((item, i) => {
        ...
        user += stellar.GLOBAL_CONFIG.plugins.lazyload.enable ? '<img class="lazy" data-src="' + (item.avatar_url || item.avatar || cfg.avatar) + '" onerror="javascript:this.src=\'' + cfg.avatar + '\';">' : '<img src="' + (item.avatar_url || item.avatar || cfg.avatar) + '" onerror="javascript:this.src=\'' + cfg.avatar + '\';">';
