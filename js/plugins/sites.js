  ...
  layout: (cfg) => {
    ...
    sitesjs.requestAPI(cfg.api, function(data) {
      ...
      arr.forEach((item, i) => {
        ...
        cell += stellar.GLOBAL_CONFIG.plugins.lazyload.enable ? '<img class="lazy" data-src="' + (item.screenshot || ('https://api.vlts.cc/screenshot?url=' + item.url + '&width=1280&height=720')) + '" onerror="javascript:this.src=\'' + cfg.screenshot + '\';"/>' : '<img src="' + (item.screenshot || ('https://api.vlts.cc/screenshot?url=' + item.url + '&width=1280&height=720')) + '" onerror="javascript:this.src=\'' + cfg.screenshot + '\';"/>';
        cell += '<div class="info">';
        cell += stellar.GLOBAL_CONFIG.plugins.lazyload.enable ? '<img class="lazy" data-src="' + (item.avatar || cfg.avatar) + '" onerror="javascript:this.src=\'' + cfg.avatar + '\';"/>' : '<img src="' + (item.avatar || cfg.avatar) + '" onerror="javascript:this.src=\'' + cfg.avatar + '\';"/>';
      ...
      stellar.GLOBAL_CONFIG.plugins.lazyload.enable && window.lazyLoadInstance?.update();
    }, function() {
